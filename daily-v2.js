(() => {
  ...
  ready(() => {
    if (!document.getElementById('dailyV2Styles')) {
      ...
      style.textContent = `
        .daily2-hero{display:grid;grid-template-columns:1fr;gap:12px}
        .daily2-date{width:100%;padding:14px;border-radius:16px;border:1px solid var(--line);background:var(--card);color:var(--text);font-size:16px}
        .daily2-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}
        .daily2-summary .metric h3{font-size:22px}
        .daily2-card{border:1px solid var(--line);border-radius:18px;padding:14px;background:var(--card);margin:10px 0}
        ...
        @media(max-width:480px){.daily2-summary{grid-template-columns:1fr}.daily2-grid{grid-template-columns:1fr 95px}}
      `;
